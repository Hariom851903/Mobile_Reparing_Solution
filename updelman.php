...
.Repaire input[type="submit"]
{
    ...
    <body>
    <div class="Repaire"><h1>Update DelivaryMan</h1>
        <form action="" method="post">
            ...
            <div class="inputuser">
                <input type="email" name="Add" required=""><label>Email</label>
            </div>
...
if(isset($_POST['submit-2']))
{
    ...
    $sql="update d_boys set Name='{$name}',Contact_no='{$phone}',email='{$email}' where D_id=$did";
